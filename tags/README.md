...
IFF terraform core module that creates tags for various AWS resources inside IFF envs


## Calling the Module
For optional variables, check the module's variables.tf file.
...
module "iff-tags" {
  ...
  awx_template_tag        = var.awx_template_tag
}
